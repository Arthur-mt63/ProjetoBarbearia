...
class Lojacontroller {
  ...
  Future<int> addUser(Loja loja) async {
  ...
  Future<List<Loja>> getLoja() async {
    ...
    final List<Map<String, dynamic>> listadeusuario = await db.query('Loja');
    ...
    return List.generate(listadeusuario.length, (int i) {
      return Loja.fromMap(listadeusuario[i]);
    });
  }
}
