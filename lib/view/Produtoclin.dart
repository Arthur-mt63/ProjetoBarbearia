  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor: const Color.fromARGB(255, 255, 252, 252), // Roxo
      ),
      body: Padding(
          ...
          children: <Widget>[
            TextField(
              ...
              decoration: InputDecoration(
                ...
                labelStyle: TextStyle(color: const Color.fromARGB(255, 68, 68, 68)), // Roxo
                ...
                itemBuilder: (context, index) {
                  return ListTile(
                    title: Text(
                      ...
                      style: TextStyle(color: const Color.fromARGB(255, 0, 0, 0)), // Roxo
                    ),
                    onTap: () {
                      showDialog(
                        context: context,
