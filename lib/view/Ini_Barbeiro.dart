        ...
        Expanded(
          child: Container(
            ...
            child: Column(
              children: [
                SizedBox(
                  height: 150, // Aumentando a altura da imagem
                  child: Padding(
    ...
    return ElevatedButton(
      ...
      child: Column(
        children: [
          Text(
            '$day',
            style: TextStyle(fontSize: 28), // Aumentando o tamanho da data
          ),
          Text(
            weekday,
            style: TextStyle(fontSize: 20), // Ajustando o tamanho do texto do dia da semana
          ),
        ],
      ),
    );
